...
const getCallApi =  async ()=>{
    let consuApi = await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=3f55c2f176564afd9954d633159c9211&addRecipeInformation=true&number=100`)
