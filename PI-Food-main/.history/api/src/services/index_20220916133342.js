...
const getCallApi =  async ()=>{
    let consuApi = await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=2c950f71897947f0aee732dce10b0670&addRecipeInformation=true&number=100`)
