...
const getCallApi =  async ()=>{
    let consuApi = await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=198cf02967bb457cb23162a04dc5880f&addRecipeInformation=true&number=100`)
