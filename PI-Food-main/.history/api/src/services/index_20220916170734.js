...
const getCallApi =  async ()=>{
    let consuApi = await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=15519e240c784d4b985f17c81116fb23&addRecipeInformation=true&number=100`)
