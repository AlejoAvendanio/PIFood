...
const getCallApi =  async ()=>{
    let consuApi = await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=2e954530b9b5443db07c23a447ea33a3&addRecipeInformation=true&number=100`)
