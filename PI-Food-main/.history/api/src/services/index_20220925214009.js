...
const getCallApi =  async ()=>{
    let consuApi = await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=2ca3f1a72e6d4f8a90676c203bbabcaa&addRecipeInformation=true&number=100`)
