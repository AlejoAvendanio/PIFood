...
const getCallApi =  async ()=>{
    let consuApi = await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=413b86561a574c1595bf949c970f913e&addRecipeInformation=true&number=100`)
