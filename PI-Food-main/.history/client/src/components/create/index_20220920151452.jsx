                    ...
                    <section>
                        <form>
                            <div className='divFormCreate'>
                                ...
                                <select onChange={handleOptionSteps}>
                                    <option value="">cantidad de steps</option>
                                    {
                                        array.map(e=><option key={e} defaultValue={e}>{e}<button onChange={handleDeleteDiet}>x</button></option>)
                                    }
                                </select>
                                <footer>{
                                    inputStep
                                ...
                                <button onSubmit={handleSubmitRepice}>submit</button>
                            </div>
