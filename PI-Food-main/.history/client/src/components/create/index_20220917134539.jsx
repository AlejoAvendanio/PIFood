...
export default function Create() {
    ...
    const handleSteps = (e)=>{
        ...
        setStep({
                ...form,
                analyzedInstructions:[...form.analyzedInstructions,form.analyzedInstructions[e-1].step=e.target.value]
            })
    }
    ...
    return (
        <div>
            ...
            <section>
                ...
                {
                    inputStep
                        ?   inputStep.map(e=><input name={e} onChange={handleSteps(e)} type='text' key={e}></input>)
