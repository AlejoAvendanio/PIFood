...
export default function Create() {
    ...
    const handleOptionSteps = (e)=>{
        ...
        setInputStep({...form,in:[...inputs]}) // seteo la cantidad de inputs para añadir informacion de cada step
    }
    ...
    return (
        <div>
            ...
            <section>
                ...
                {
                    inputStep.inputs
                        ?   inputStep.inputs.map(e=><input name={e} onChange={handleSteps} type='text' key={e}></input>)
