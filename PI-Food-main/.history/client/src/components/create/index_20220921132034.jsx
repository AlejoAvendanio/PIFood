...
import fondo from '../img/create.png'
    ...
    return (
        <div>
            <header className='headerCreate'>    
                <Link to={'/home'}><img src={imgHome}/><p>Home</p></Link>  
            </header>
                    ...
                    <section>
                        <form>
                            <div className='divFormCreate'>
                                ...
                                <button className='buttonSubmit' onSubmit={(e)=>handleSubmitRepice(e)}>submit</button>
                            </div>
