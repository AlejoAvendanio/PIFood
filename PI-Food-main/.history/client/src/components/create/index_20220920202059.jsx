                        ...
                        <form>
                            <div className='divFormCreate'>
                                ...
                                <ul><p>Dietas ingresadas:</p>
                                        {form.diets?.map(d=><li>{d} <button className='buttonDelete' onClick={()=>{handleDeleteDiet(d)}}><b>X</b></button></li>)}
                                </ul>
                                ...
                                <button className='buttonSubmit' onSubmit={handleSubmitRepice}>submit</button>
                            </div>
