      ...
      <div className='home'>
        {
          ...
          return(
          <Card 
          title={element.title || element.dataValues.title}
          diets={element.diets?.[0].name ? element.diets?.map(e=>e.name) : element.diets}
          healthScore={element.healthScore || element.dataValues.healthScore}
          id={element.id || element.dataValues.id}
          img={element.image || element.dataValues.image}
          key={element.id}
          />
          )})
        }
