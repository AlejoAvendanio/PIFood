...
export default function rootReducer(state = inicialState, action){
    switch(action.type){
        ...
        case ORDER_BY_NAME:
            ...
            food = food.sort((a,b)=>{
                const titleA = a.title.toLowerCase() || a.dataValue.title.titletoLowerCase()
                const titleB = b.title.toLowerCase()|| b.dataValue.title.titletoLowerCase()
        ...
        case ORDER_BY_SCORE:
            ...
            score = score.sort((a,b)=>{
                const scoreA = a.healthScore || a.dataValue.healthScore
                const scoreB = b.healthScore|| b.dataValue.healthScore
                if(action.payload==='ASCENDENTE'){
