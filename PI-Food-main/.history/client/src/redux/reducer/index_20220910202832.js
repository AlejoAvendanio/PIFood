...
import  {FILTER_BY_DIETS, GET_DIETS, GET_FOOD, GET_NAME_QUERY, ORDER_BY_NAME, ORDER_BY_SCORE} from '../actions/index'
    ...
    switch(action.type){
        ...
        case ORDER_BY_SCORE:
            ...
            score = score.sort((a,b)=>{
                const scoreA = a.healthDcore.parseInt()
                const scoreB = b.healthDcore.parseInt()
                if(action.payload==='ASCENDENTE'){
